...
define([ 'commander', './CommandLine' ], function( program, CommandLine ) {
	...
	return function(){
		...
		program.on('--help', function(){
			console.log( 'See the man page or https://github.com/fivetanley/warn.js/ for a list of predefined globals.  Options to enable or disable are available there, or you may use the JSHint names like forin or eval');
		});
